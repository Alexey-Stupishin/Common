...
public:
    ...
    uint32_t rot_plane(CagmVectorFieldOps *a, int kz);
	...
	uint32_t grad_plane(CagmScalarFieldOps *a, int kz);
    ...
    uint32_t mult_plane(REALTYPE_A c, CagmVectorFieldOps *a, int kz);
