...
public:
    ...
    uint32_t div_plane(CagmVectorFieldOps *a, int kz);
    ...
    uint32_t mult_plane(REALTYPE_A c, CagmScalarFieldOps *a, int kz);
    uint32_t mult(REALTYPE_A c);
	uint32_t mult(CagmScalarFieldOps *c, CagmScalarFieldOps *a);
    uint32_t mult_plane(CagmScalarFieldOps *c, CagmScalarFieldOps *a, int kz);
    ...
    REALTYPE_A sum_plane(int kz, CagmScalarFieldOps *weight = nullptr);
